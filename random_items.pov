...
object{gymTag scale<1.5,1.5,1.5> rotate<90,150,0> translate<-2,0.21,-4.23>} 
...
object{highlighter scale <1.5,1.25,1.25> rotate<0,180,0> translate<-0.8,0.35,-3.40>}
object{phone scale <-0.55,0,0> rotate<0,270,0> translate<-1.5,-1.175,-1.85>}
object{wallet scale<2.3,2.3,1.755> rotate<167,15,0> translate<-3.35,1,-5.1>}  